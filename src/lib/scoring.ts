...
const TOEFL_LISTENING_SCALED: Record<number, number> = {
  ...
  20: 38, 19: 38, 18: 37, 17: 36, 16: 35, 15: 34, 14: 33, 13: 31, 12: 30, 11: 29,
  10: 27, 9: 26, 8: 25, 7: 24, 6: 24, 5: 24, 4: 24, 3: 24, 2: 24, 1: 24, 0: 24,
};
...
const TOEFL_STRUCTURE_SCALED: Record<number, number> = {
  ...
  10: 33, 9: 31, 8: 29, 7: 27, 6: 25, 5: 23, 4: 23, 3: 22, 2: 21, 1: 20, 0: 20,
};
...
const TOEFL_READING_SCALED: Record<number, number> = {
  ...
  40: 57, 39: 56, 38: 55, 37: 54, 36: 53, 35: 52, 34: 52, 33: 51, 32: 50, 31: 49,
  30: 48, 29: 47, 28: 46, 27: 45, 26: 44, 25: 43, 24: 42, 23: 41, 22: 40, 21: 39,
  20: 38, 19: 37, 18: 37, 17: 36, 16: 35, 15: 34, 14: 33, 13: 32, 12: 31, 11: 30,
  10: 29, 9: 28, 8: 27, 7: 26, 6: 25, 5: 24, 4: 24, 3: 23, 2: 22, 1: 21, 0: 21,
};
...
export function calcToeflScore(sections: SimulationSection[], answers: Record<string, string>) {
  ...
  const overall = Math.round(((listeningScaled + structureScaled + readingScaled) * 10) / 3);
